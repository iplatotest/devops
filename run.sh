...
popd
pushd /vagrant
docker build ./services/account -t iplatotest/platformtest-account
docker build ./services/gateway -t iplatotest/platformtest-gateway
docker build ./services/payment -t iplatotest/platformtest-payment
docker-compose up -d
popd
